...
const DriverPerformance = () => {
  const metrics = [
    { icon: CheckCircle2, label: "Tingkat Penyelesaian", value: "98%", status: "Sangat Baik", color: "text-driver-success", bg: "bg-driver-success-light" },
    { icon: Clock, label: "Waktu Tunggu Rata-rata", value: "3.5m", status: "Efisien", color: "text-driver-info", bg: "bg-driver-info-light" },
    { icon: AlertTriangle, label: "Tingkat Pembatalan", value: "2%", status: "Rendah", color: "text-destructive", bg: "bg-destructive/10" },
    { icon: Star, label: "Rating Keseluruhan", value: "4.92", status: "Sangat Baik", color: "text-driver-warning", bg: "bg-driver-warning-light" },
  ];
        ...
        <div className="p-8 rounded-3xl bg-card border border-border/50 shadow-md flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-3 p-1.5 px-3 rounded-full bg-muted w-fit border border-border/50">
              <Star className="h-4 w-4 text-driver-warning fill-driver-warning" />
        ...
        <section aria-label="Program Hadiah">
          <div className="p-8 rounded-3xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-xl shadow-primary/20 relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <button className="mt-6 px-6 py-3 rounded-2xl bg-card text-primary font-black text-xs uppercase tracking-widest shadow-lg hover:bg-card/90 transition-all active:scale-95">
                Lihat Program
              </button>
            </div>
            <div className="absolute -bottom-8 -right-8 h-32 w-32 bg-primary-foreground/10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000" />
          </div>
        </section>
      </div>
    </DriverLayout>
