...
import { User, Shield, CreditCard, HelpCircle, LogOut, ChevronRight, Settings, Info, Truck, ShieldCheck, Star } from "lucide-react";
    ...
    <DriverLayout>
      <div className="flex flex-col gap-8 p-4">
        ...
        <div className="flex flex-col items-center justify-center py-6 text-center">
          <div className="relative mb-4 group cursor-pointer">
            <div className="h-28 w-28 rounded-full border-4 border-primary p-1 shadow-xl transition-transform group-hover:scale-105">
              <div className="h-full w-full rounded-full bg-muted flex items-center justify-center overflow-hidden border-2 border-card shadow-inner">
          ...
          <div className="flex items-center gap-2 mt-4">
            <div className="px-3 py-1.5 rounded-full bg-muted border border-border/50 flex items-center gap-1.5">
              <Star className="h-3.5 w-3.5 text-driver-warning fill-driver-warning" />
        ...
        <section aria-label="Informasi Kendaraan">
          <div className="p-6 rounded-3xl bg-muted/50 border border-border/50 shadow-sm flex items-center justify-between group cursor-pointer hover:bg-muted/80 transition-all">
            <div className="flex gap-4 items-center">
              <div className="p-3 rounded-2xl bg-card shadow-sm group-hover:scale-110 transition-transform">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="p-3 rounded-xl bg-primary-foreground/20 shadow-inner group-hover:scale-110 transition-transform">
              <User className="h-6 w-6" />
            </div>
            <div className="flex-1">
              <p className="font-black text-base leading-tight uppercase tracking-widest">Kembali ke Klumpang GO</p>
              <p className="text-xs font-medium text-primary-foreground/80 mt-1 tracking-tight">Pesan layanan Klumpang</p>
            </div>
            <ChevronRight className="h-5 w-5 text-primary-foreground/50 group-hover:translate-x-1 transition-transform" />
          </Link>
